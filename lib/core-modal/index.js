...
var CoreModal = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(CoreModal, [{
    ...
    get: function get() {
      ...
      return openerType === 'none' ? modal : openerType === 'custom' ? opener ? /*#__PURE__*/React.createElement("span", {
        onClick: this.toggle
      }, opener, modal) : modal : openerType === 'switch' ? /*#__PURE__*/React.createElement(Switch, {
        isChecked: isOpen,
    ...
    get: function get() {
      ...
      return shouldRender && /*#__PURE__*/React.createElement("footer", null, onConfirm && /*#__PURE__*/React.createElement(PrimaryCoreButton, {
        onClick: this.confirm,
        isDisabled: isConfirmDisabled
      }, confirmText), onCancel && /*#__PURE__*/React.createElement(TertiaryCoreButton, {
        onClick: this.cancel,
    ...
    get: function get() {
      ...
      return isOpen && /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("div", {
        ref: this.maskRef,
      ...
      }, /*#__PURE__*/React.createElement("header", null, title, canClose && /*#__PURE__*/React.createElement(Button, {
        type: "text",
        className: "close-btn",
        onClick: this.close
        ...
        className: "content"
      }, children), footer), /*#__PURE__*/React.createElement(EventListener, {
        target: document,
