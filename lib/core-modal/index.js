...
function (_PureComponent) {
  ...
  function CoreModal() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(CoreModal)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "maskRef", createRef());
  ...
  _createClass(CoreModal, [{
    ...
    get: function get() {
      ...
      return openerType === 'none' ? modal : openerType === 'custom' ? opener ? React.createElement("span", {
        onClick: this.toggle
      }, opener, modal) : modal : openerType === 'switch' ? React.createElement(Switch, {
        isChecked: isOpen,
    ...
    get: function get() {
      ...
      return shouldRender && React.createElement("footer", null, onConfirm && React.createElement(PrimaryCoreButton, {
        onClick: this.confirm,
        isDisabled: isConfirmDisabled
      }, confirmText), onCancel && React.createElement(TertiaryCoreButton, {
        onClick: this.cancel,
    ...
    get: function get() {
      ...
      return isOpen && React.createElement(Fragment, null, React.createElement("div", {
        ref: this.maskRef,
      ...
      }, React.createElement("header", null, title, canClose && React.createElement(Button, {
        type: "text",
        className: "close-btn",
        onClick: this.close
        ...
        className: "content"
      }, children), footer), React.createElement(EventListener, {
        target: document,
