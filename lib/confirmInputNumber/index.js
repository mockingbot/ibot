...
function (_PureComponent) {
  ...
  function ConfirmInputNumber() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ConfirmInputNumber)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(ConfirmInputNumber, [{
    ...
    value: function componentDidUpdate(_ref3) {
      ...
      if (!isEqual_1(prevTitle, title) || !isEqual_1(prevPrefix, prefix) || !isEqual_1(prevSuffix, suffix)) {
        this.positionEverything();
      }
    }
  }, {
