  ...
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      return React.createElement("label", {
        ...
        onClick: this.toggle,
        disabled: isDisabled
      }, React.createElement(Ellipsis, null, this.displayText)), React.createElement("span", {
        className: "caret",
        dangerouslySetInnerHTML: {
          __html: SVG.INPUT_ARROW
        }
      }), React.createElement(SelectMenu, _extends({
        isOpen: isOpen
      }, this.props, {
        value: value,
        $select: $select,
    ...
    get: function get() {
      ...
      var group = optionList.find(function (g) {
        return isArray_1(g) && g.slice(0).some(function (o) {
          return checkOptionByValue(o, value);
        });
      });
      var option = (group || optionList).find(function (o) {
        return !isArray_1(o) && checkOptionByValue(o, value);
      });
...
function (_PureComponent2) {
  ...
  function SelectMenu() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(SelectMenu)).call.apply(_getPrototypeOf3, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this2), "menuBaseRef", createRef());
    ...
    _defineProperty(_assertThisInitialized(_this2), "position", function (e) {
      ...
      if (e) {
        var $target = get_1(e, 'target');
        if ($target && isElement_1($target) && $target.matches('.SelectMenu')) return;
      }
  ...
  _createClass(SelectMenu, [{
    ...
    get: function get() {
      ...
      }, isEmpty ? React.createElement("li", {
        className: "SelectOption empty-msg"
      }, emptyMsg) : optionList.map(function (option, idx) {
        return isArray_1(option) ? React.createElement(Group, {
          key: idx,
          menuTheme: menuTheme,
          optionList: option,
          value: value,
      ...
      }), isOpen && React.createElement(EventListener, {
        target: document,
...
_defineProperty(SelectMenu, "propTypes", _objectSpread2({}, Select.propTypes, {
...
function Group(_ref5) {
  ...
  return React.createElement("li", {
    ...
    className: "title",
    onClick: onChange
  }, title), React.createElement("ul", null, optionList.map(function (option, idx) {
...
function Option(_ref6) {
  ...
  }, React.createElement(Ellipsis, null, label), menuTheme === 'check' && isActive && React.createElement(Icon, {
    name: "check",
    type: "dora"
  }));
}
