  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var contentProp = html ? {
        ...
        children: React.createElement(Fragment, null, isLoading && React.createElement(SVG, {
          name: "loading"
        }), icon && (iconType === 'svg' ? React.createElement(SVG, {
          name: icon
      ...
      }, omit_1(others, ['className', 'type', 'theme', 'isDisabled', 'disabled', 'isLoading', 'loading', 'to', 'nativeLink']), {}, contentProp);
...
function PrimaryCoreButton(props) {
  return React.createElement(CoreButton, _extends({}, props, {
    type: "primary"
  }));
}
