...
var Overlay = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Overlay, [{
    ...
    get: function get() {
      ...
      return openerType === 'none' ? overlay : openerType === 'custom' ? opener ? /*#__PURE__*/React.createElement("span", {
        onClick: this.open
      }, opener, overlay) : overlay : openerType === 'switch' ? /*#__PURE__*/React.createElement(Switch, {
        isChecked: isOpen,
    ...
    get: function get() {
      ...
      }, title && /*#__PURE__*/React.createElement("h1", null, title), children, shouldShowFooter && /*#__PURE__*/React.createElement("footer", null, onConfirm && /*#__PURE__*/React.createElement(PrimaryCoreButton, {
