...
function (_PureComponent) {
  ...
  _createClass(Overlay, [{
    ...
    get: function get() {
      ...
      var isOpen = this.state.isOpen;
      var overlay = createPortal(this.overlay, this.portal);
      return openerType === 'none' ? overlay : openerType === 'custom' ? opener ? React.createElement("span", {
        onClick: this.open
      }, opener, overlay) : overlay : openerType === 'switch' ? React.createElement(Switch, {
        isChecked: isOpen,
    ...
    get: function get() {
      ...
      }, title && React.createElement("h1", null, title), children, shouldShowFooter && React.createElement("footer", null, onConfirm && React.createElement(PrimaryCoreButton, {
