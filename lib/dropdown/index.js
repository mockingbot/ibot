  ...
  function Dropdown() {
    ...
    _defineProperty(_assertThisInitialized(_this), "toggle", function (willBeOpen) {
      return _this.setState({
        isOpen: isBoolean_1(willBeOpen) ? willBeOpen : !_this.state.isOpen
      });
    });
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      return React.createElement("label", {
        ref: this.set$opener,
        className: klass
      }, openerType !== 'button' && isValidElement(opener) ? cloneElement(opener, openerAttr) : React.createElement("button", _extends({
        type: "button"
      }, openerAttr), opener), React.createElement(DropdownMenu, _extends({}, this.props, {
        isOpen: isOpen,
        $opener: $opener,
    ...
    value: function getDerivedStateFromProps(props, _ref4) {
      ...
      if (!isEqual_1(props, prevProps)) {
        if (isBoolean_1(props.isOpen)) {
          return {
            prevProps: props,
            isOpen: props.isOpen
          };
...
function (_PureComponent2) {
  ...
  function DropdownMenu() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(DropdownMenu)).call.apply(_getPrototypeOf3, [this].concat(args)));
  ...
  _createClass(DropdownMenu, [{
    ...
    get: function get() {
      ...
      return React.createElement("div", {
        ...
        className: klass
      }, arrowed && React.createElement("span", {
        className: "arrow",
        ...
        className: "content"
      }, menuList ? React.createElement("ul", {
        className: "MenuList"
      ...
      })) : menu), isOpen && React.createElement(EventListener, {
        target: document,
...
_defineProperty(DropdownMenu, "propTypes", _objectSpread2({}, Dropdown.propTypes, {
  isOpen: PropTypes.bool,
