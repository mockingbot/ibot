...
function (_PureComponent) {
  ...
  function InputNumber() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(InputNumber)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "onBlur", function (e) {
      ...
      if (!value && isNumber_1(valueForEmptyInput)) {
  ...
  _createClass(InputNumber, [{
    ...
    value: function render() {
      ...
      return React.createElement("label", {
        ...
        className: "desc"
      }, desc), prefix && React.createElement("span", {
        className: "prefix"
      }, prefix), React.createElement("input", _extends({
        /**
        ...
        onFocus: onFocus,
        onBlur: this.onBlur
      }, getOtherProps(this.constructor, this.props))), suffix && React.createElement("span", {
        className: "suffix",
        "data-value": formatter(value),
        "data-suffix": suffix
      }, React.createElement("span", null, suffix)), React.createElement(InputActionButton, {
        hasMenu: hasMenu,
        onToggleMenu: this.toggleMenu,
        onStep: this.onStep,
        onRelease: this.onRelease
      }), hasMenu && React.createElement(SelectMenu, {
        isOpen: isMenuOpen,
      ...
      }), (isActive || isMenuOpen) && React.createElement(EventListener, {
        target: document,
...
function (_PureComponent2) {
  ...
  function InputActionButton() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(InputActionButton).apply(this, arguments));
  }
  ...
  _createClass(InputActionButton, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, hasMenu ? React.createElement("div", {
