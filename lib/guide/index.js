...
function (_PureComponent) {
  ...
  function GuideBase() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(GuideBase)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(GuideBase, [{
    ...
    value: function render() {
      ...
      var base = isValidElement(children) ? cloneElement(children, {
        ref: this.set$base
      }) : React.createElement("span", {
        ref: this.set$base
      }, children);
      var guide = createPortal(this.renderGuide(), this.portal);
      return React.createElement(Fragment, null, base, guide);
    }
  }, {
    key: "renderGuide",
    value: function renderGuide() {
      ...
      return React.createElement("div", {
        ...
        className: "content"
      }, header && React.createElement("header", null, header), !noCloseBtn && React.createElement("button", {
        className: "close-btn",
        onClick: this.close
      }, React.createElement(Icon, {
        name: "times_fc",
        type: "dora"
      })), guide, gotItBtn && React.createElement("footer", null, React.createElement(Button, {
        type: "text",
        onClick: this.close
      }, gotItText))), isOpen && React.createElement(EventListener, {
        target: document,
