...
function (_PureComponent) {
  ...
  function InputEmail() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(InputEmail)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(InputEmail, [{
    ...
    value: function render() {
      ...
      return React.createElement("label", {
        ...
        onFocus: onFocus
      }, getOtherProps(this.constructor, this.props))), isActive && React.createElement(EventListener, {
        target: document,
