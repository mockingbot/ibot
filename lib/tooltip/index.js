...
function parseContent(content) {
  ...
  return isString_1(content) || isArray_1(content) || isValidElement(content) ? content : EVENT_NAME_LIST.includes(eventName) && isObject_1(content) ? content[eventName] || content.hover : null;
}
...
function (_PureComponent) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      }, getOtherProps(this.constructor, this.props)), // Children:
      React.createElement(Fragment, null, html ? React.createElement("span", {
...
function (_PureComponent2) {
  ...
  function Tip() {
    ...
    _this3 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(Tip)).call.apply(_getPrototypeOf3, [this].concat(args)));
  ...
  _createClass(Tip, [{
    ...
    get: function get() {
      ...
      }, arrowed && React.createElement("div", {
        className: "arrow",
        dangerouslySetInnerHTML: {
