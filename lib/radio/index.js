...
function (_PureComponent2) {
  ...
  function RadioGroup() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(RadioGroup)).call.apply(_getPrototypeOf3, [this].concat(args)));
  ...
  _createClass(RadioGroup, [{
    ...
    value: function render() {
      ...
      return React.createElement("span", {
        ...
        return opt && React.createElement(Radio, {
          key: idx,
          name: name,
          size: size,
          theme: theme,
