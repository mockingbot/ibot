...
.add('Tooltip', () => (
  <Root>
    ...
    <p>
      <Tooltip content="How you greet in English.">Hello</Tooltip>
      <br />
      <Tooltip content={['The apple of Rachel’s ', <Icon name="eye" key="icon" />]}><span>Ross</span></Tooltip>
      <br />
      <Tooltip
        id="tt_test"
    ...
    <h3>On top</h3>
    <p className="three">
      <Tooltip position="top" content="漢語的問候方式">你好</Tooltip>
      <Tooltip position="top" content="漢語的問候方式">你好</Tooltip>
      <Tooltip position="top" content="漢語的問候方式">你好</Tooltip>
    </p>
    ...
    <h3>On left</h3>
    <p className="three">
      <Tooltip position="left" content="How to laugh subculturally in Chinese">233</Tooltip>
      <Tooltip position="left" content="How to laugh subculturally in Chinese">233</Tooltip>
      <Tooltip position="left" content="How to laugh subculturally in Chinese">233</Tooltip>
    </p>
    ...
    <h3>On right</h3>
    <p className="three">
      <Tooltip position="right" content="How to laugh subculturally in English">LOL</Tooltip>
      <Tooltip position="right" content="How to laugh subculturally in English">LOL</Tooltip>
      <Tooltip position="right" content="How to laugh subculturally in English">LOL</Tooltip>
    </p>
    ...
    <h3>On bottom</h3>
    <p className="three">
      <Tooltip position="bottom" inflexible={false} content="How to laugh subculturally in Thai">555</Tooltip>
      <Tooltip position="bottom" inflexible={false} content="How to laugh subculturally in Thai">555</Tooltip>
      <Tooltip position="bottom" inflexible={false} content="How to laugh subculturally in Thai">555</Tooltip>
    </p>
    ...
    <h3>On top</h3>
    <p className="three">
      <Tooltip position="top" inflexible={true} content="How to luagh subculturally in Chinese">廠廠</Tooltip>
      <Tooltip position="top" inflexible={true} content="How to luagh subculturally in Chinese">廠廠</Tooltip>
      <Tooltip position="top" inflexible={true} content="How to luagh subculturally in Chinese">廠廠</Tooltip>
    </p>
    ...
    <h3>On left</h3>
    <p className="three">
      <Tooltip position="left" inflexible content="How to laugh subculturally in Japanese">www</Tooltip>
      <Tooltip position="left" inflexible content="How to laugh subculturally in Japanese">www</Tooltip>
      <Tooltip position="left" inflexible content="How to laugh subculturally in Japanese">www</Tooltip>
    </p>
    ...
    <h3>On right</h3>
    <p className="three">
      <Tooltip position="right" inflexible content="How to laugh in Español">Jaja</Tooltip>
      <Tooltip position="right" inflexible content="How to laugh in Español">Jaja</Tooltip>
      <Tooltip position="right" inflexible content="How to laugh in Español">Jaja</Tooltip>
    </p>
    ...
    <h3>On bottom</h3>
    <p className="three">
      <Tooltip position="bottom" inflexible content="How to laugh in Korean">ㅎㅎㅎ</Tooltip>
      <Tooltip position="bottom" inflexible content="How to laugh in Korean">ㅎㅎㅎ</Tooltip>
      <Tooltip position="bottom" inflexible content="How to laugh in Korean">ㅎㅎㅎ</Tooltip>
    </p>
    ...
    <h2>Tips with regular nodes</h2>
    <p>
      <Tooltip content="Am an idiot sandwich." position="left">What are you?</Tooltip>
    </p>

    <p className="button">
      <Tooltip content="三维/三D/three dimensional" position="left">
